...
export const MENTORS: Mentor[] = [
  ...
  {
    name: "Stephanie 老师",
    title: "帝国理工学院公共卫生硕士 | 伦敦大学学院人口健康科学本科一等学位",
    specialties: ["英式学术写作与逻辑训练", "批判性思维与论证能力培养", "IB体系及其竞赛辅导"]
  },
  {
    name: "Vivian 老师",
    title: "佐治亚理工学院数据分析硕士(数据科学方向) | 8年以上硕博申请辅导经验",
    specialties: ["大健康x数据科学", "数据分析", "学术与实践背景整合，文书逻辑构建与个人动机深度挖掘"]
  }
];
